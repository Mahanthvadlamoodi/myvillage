...
function calculateCompoundInterest() {
  ...
  if (timePeriod <= 1) {
    ...
    //var compoundPeriod = Math.floor(timePeriod * 12); // Calculate total number of months
    var compoundPeriod=timePeriod;
    compoundInterest = principal * (Math.pow((1 + interestRate / 100), compoundPeriod)-1);
  }
